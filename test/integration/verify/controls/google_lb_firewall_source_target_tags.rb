...
control "google-lb-internal-firewall-rule-target-tags-1.0" do
  ...
  describe google_compute_firewall(project: gcp_project_id, name: "inspec-gcp-tag-test-fw") do
    ...
    it { should allow_target_tags_only %w{allow-gcp-inspec-app-mig2 allow-gcp-inspec-app-mig3} }
    ...
    it { should_not allow_source_tags_only %w{allow-gcp-inspec-app-mig1 not_existing} }
  end
end