...
gcp_storage_bucket_name = input(:gcp_storage_bucket_name, value: 'gcp_storage_bucket_name', description: 'The name of the storage bucket with the default object ACL')
