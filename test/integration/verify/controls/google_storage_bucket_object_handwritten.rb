...
gcp_storage_bucket_object = input(:gcp_storage_bucket_object, value: '', description: 'The GCP bucket with objects.')
gcp_storage_bucket_object_name = input(:gcp_storage_bucket_object_name, value: '', description: 'The GCP bucket object name.')
