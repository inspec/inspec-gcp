...
folder_exclusion = input('folder_exclusion', default: {"name"=>"inspec-folder-exclusion", "description"=>"My folder exclusion description", "filter"=>"resource.type = gce_instance AND severity <= DEBUG"})
