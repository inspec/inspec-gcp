...
class ComputeHealthCheck < GcpResourceBase
  ...
  attr_reader :params, :check_interval_sec, :creation_timestamp, :description, :healthy_threshold, :id, :name, :timeout_sec, :unhealthy_threshold, :type, :http_health_check, :https_health_check, :tcp_health_check, :ssl_health_check, :http2_health_check
