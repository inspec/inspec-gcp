  ...
  def un_parse
    {
      ...
      'http_health_check' => ->(x, path) { x.nil? ? [] : GoogleInSpec::Compute::Property::HealthCheckHttpHealthCheck.un_parse(x, "http_health_check") },
      'https_health_check' => ->(x, path) { x.nil? ? [] : GoogleInSpec::Compute::Property::HealthCheckHttpsHealthCheck.un_parse(x, "https_health_check") },
      'tcp_health_check' => ->(x, path) { x.nil? ? [] : GoogleInSpec::Compute::Property::HealthCheckTcpHealthCheck.un_parse(x, "tcp_health_check") },
      'ssl_health_check' => ->(x, path) { x.nil? ? [] : GoogleInSpec::Compute::Property::HealthCheckSslHealthCheck.un_parse(x, "ssl_health_check") },
      'http2_health_check' => ->(x, path) { x.nil? ? [] : GoogleInSpec::Compute::Property::HealthCheckHttp2HealthCheck.un_parse(x, "http2_health_check") },
    }
  end
