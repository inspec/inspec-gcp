...
class ComputeDisk < GcpResourceBase
  ...
  attr_reader :params, :label_fingerprint, :creation_timestamp, :description, :id, :last_attach_timestamp, :last_detach_timestamp, :labels, :licenses, :name, :size_gb, :users, :physical_block_size_bytes, :type, :source_image, :zone, :source_image_encryption_key, :source_image_id, :disk_encryption_key, :source_snapshot, :source_snapshot_encryption_key, :source_snapshot_id
