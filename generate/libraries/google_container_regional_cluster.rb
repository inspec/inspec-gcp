...
class ContainerRegionalCluster < GcpResourceBase
  ...
  attr_reader :params, :name, :description, :initial_node_count, :node_config, :master_auth, :logging_service, :monitoring_service, :network, :private_cluster_config, :cluster_ipv4_cidr, :addons_config, :subnetwork, :locations, :resource_labels, :label_fingerprint, :legacy_abac, :network_policy, :default_max_pods_constraint, :ip_allocation_policy, :endpoint, :initial_cluster_version, :current_master_version, :current_node_version, :create_time, :status, :status_message, :node_ipv4_cidr_size, :services_ipv4_cidr, :current_node_count, :expire_time, :enable_tpu, :tpu_ipv4_cidr_block, :conditions, :master_authorized_networks_config, :location
