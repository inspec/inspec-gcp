  ...
  module Compute
    module Property
      class BackendServiceBackends
        attr_reader :arguments, :balancing_mode, :capacity_scaler, :description, :group, :max_connections, :max_connections_per_instance, :max_connections_per_endpoint, :max_rate, :max_rate_per_instance, :max_rate_per_endpoint, :max_utilization
