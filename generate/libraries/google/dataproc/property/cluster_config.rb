...
module GoogleInSpec
  module Dataproc
    module Property
      class ClusterConfig
        attr_reader :arguments, :config_bucket, :gce_cluster_config, :master_config, :worker_config, :secondary_worker_config, :software_config, :initialization_actions, :encryption_config, :security_config
