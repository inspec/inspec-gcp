...
control 'Route_5' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-40615abdf6753700"}) do
    it { should exist }

    its('dest_range') { should cmp "10.166.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.166.0.0/20." }
    its('name') { should cmp "default-route-40615abdf6753700" }
