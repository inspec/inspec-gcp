...
control 'Route_15' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-af92ca117e5218af"}) do
    it { should exist }

    its('dest_range') { should cmp "10.132.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.132.0.0/20." }
    its('name') { should cmp "default-route-af92ca117e5218af" }
