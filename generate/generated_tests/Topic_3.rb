...
control 'Topic_3' do
  ...
  describe google_pubsub_topic({:project=>"graphite-test-sam-chef", :name=>"container-analysis-notes-v1beta1"}) do
    it { should exist }

    its('name') { should cmp "container-analysis-notes-v1beta1" }
