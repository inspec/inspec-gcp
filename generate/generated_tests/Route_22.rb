...
control 'Route_22' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-ed684b60b0f07c2a"}) do
    it { should exist }

    its('dest_range') { should cmp "10.146.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.146.0.0/20." }
    its('name') { should cmp "default-route-ed684b60b0f07c2a" }
