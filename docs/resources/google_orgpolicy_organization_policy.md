---
title: About the google_orgpolicy_organization_policy resource
platform: gcp
---

## Syntax
A `google_orgpolicy_organization_policy` is used to test a Google OrganizationPolicy resource

## Examples
```
describe google_orgpolicy_organization_policy(name: ' value_name') do
	it { should exist }
