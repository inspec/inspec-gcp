---
title: About the google_compute_region_target_https_proxy resource
platform: gcp
---

## Syntax
A `google_compute_region_target_https_proxy` is used to test a Google RegionTargetHttpsProxy resource
