...
# ----------------------------------------------------------------------------
require 'gcp_backend'
class ComputeRegionHealthCheckServices < GcpResourceBase
  name 'google_compute_region_health_check_services'
  desc 'RegionHealthCheckService plural resource'
  ...
  filter_table_config.add(:health_status_aggregation_strategies, field: :health_status_aggregation_strategy)
  ...
  def initialize(params = {})
    ...
    @params = params
    @table = fetch_wrapped_resource('regionHealthCheckServices')
  end
  ...
  def transformers
    {
      ...
      'healthStatusAggregationStrategy' => ->(obj) { [:health_status_aggregation_strategy, obj['healthStatusAggregationStrategy']] },
