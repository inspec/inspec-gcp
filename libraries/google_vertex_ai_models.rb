...
class VertexAIModels < GcpResourceBase
  ...
  def transformers
    {
      'modelSourceInfo' => ->(obj) { return :model_source_info, GoogleInSpec::VertexAI::Property::ModelModelSourceInfo.new(obj['modelSourceInfo'], to_s) },
      ...
      'deployedModels' => ->(obj) { return :deployed_models, GoogleInSpec::VertexAI::Property::ModelDeployedModelsArray.parse(obj['deployedModels'], to_s) },
      'createTime' => ->(obj) { return :create_time, obj['createTime'] },
      'explanationSpec' => ->(obj) { return :explanation_spec, GoogleInSpec::VertexAI::Property::ModelExplanationSpec.new(obj['explanationSpec'], to_s) },
      'encryptionSpec' => ->(obj) { return :encryption_spec, GoogleInSpec::VertexAI::Property::ModelEncryptionSpec.new(obj['encryptionSpec'], to_s) },
      'pipelineJob' => ->(obj) { return :pipeline_job, obj['pipelineJob'] },
      'predictSchemata' => ->(obj) { return :predict_schemata, GoogleInSpec::VertexAI::Property::ModelPredictSchemata.new(obj['predictSchemata'], to_s) },
      'versionUpdateTime' => ->(obj) { return :version_update_time, obj['versionUpdateTime'] },
      'supportedExportFormats' => ->(obj) { return :supported_export_formats, GoogleInSpec::VertexAI::Property::ModelSupportedExportFormatsArray.parse(obj['supportedExportFormats'], to_s) },
      'originalModelInfo' => ->(obj) { return :original_model_info, GoogleInSpec::VertexAI::Property::ModelOriginalModelInfo.new(obj['originalModelInfo'], to_s) },
      'metadataArtifact' => ->(obj) { return :metadata_artifact, obj['metadataArtifact'] },
      'supportedInputStorageFormats' => ->(obj) { return :supported_input_storage_formats, obj['supportedInputStorageFormats'] },
      'metadataSchemaUri' => ->(obj) { return :metadata_schema_uri, obj['metadataSchemaUri'] },
      'containerSpec' => ->(obj) { return :container_spec, GoogleInSpec::VertexAI::Property::ModelContainerSpec.new(obj['containerSpec'], to_s) },
      'versionId' => ->(obj) { return :version_id, obj['versionId'] },
      'artifactUri' => ->(obj) { return :artifact_uri, obj['artifactUri'] },
      'trainingPipeline' => ->(obj) { return :training_pipeline, obj['trainingPipeline'] },
      'displayName' => ->(obj) { return :display_name, obj['displayName'] },
      'supportedDeploymentResourcesTypes' => ->(obj) { return :supported_deployment_resources_types, obj['supportedDeploymentResourcesTypes'] },
      'supportedOutputStorageFormats' => ->(obj) { return :supported_output_storage_formats, obj['supportedOutputStorageFormats'] },
      'versionAliases' => ->(obj) { return :version_aliases, obj['versionAliases'] },
      'versionCreateTime' => ->(obj) { return :version_create_time, obj['versionCreateTime'] },
      'versionDescription' => ->(obj) { return :version_description, obj['versionDescription'] },
      'labels' => ->(obj) { return :labels, GoogleInSpec::VertexAI::Property::ModelLabels.new(obj['labels'], to_s) },
    }
  end
