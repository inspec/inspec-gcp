    ...
    module Property
      class DeidentifyTemplateDeidentifyConfigInfoTypeTransformationsTransformationsPrimitiveTransformationCryptoReplaceFfxFpeConfigCryptoKey
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @transient = GoogleInSpec::DataLossPrevention::Property::DeidentifyTemplateDeidentifyConfigInfoTypeTransformationsTransformationsPrimitiveTransformationCryptoReplaceFfxFpeConfigCryptoKeyTransient.new(args['transient'], to_s)
          @unwrapped = GoogleInSpec::DataLossPrevention::Property::DeidentifyTemplateDeidentifyConfigInfoTypeTransformationsTransformationsPrimitiveTransformationCryptoReplaceFfxFpeConfigCryptoKeyUnwrapped.new(args['unwrapped'], to_s)
          @kms_wrapped = GoogleInSpec::DataLossPrevention::Property::DeidentifyTemplateDeidentifyConfigInfoTypeTransformationsTransformationsPrimitiveTransformationCryptoReplaceFfxFpeConfigCryptoKeyKmsWrapped.new(args['kmsWrapped'], to_s)
        end

        def to_s
          "#{@parent_identifier} DeidentifyTemplateDeidentifyConfigInfoTypeTransformationsTransformationsPrimitiveTransformationCryptoReplaceFfxFpeConfigCryptoKey"
        end
      end
    end
  end
