...
module GoogleInSpec
  module DataLossPrevention
    module Property
      class DlpJobRiskDetailsDeidentifyDetails
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @deidentify_stats = GoogleInSpec::DataLossPrevention::Property::DlpJobRiskDetailsDeidentifyDetailsDeidentifyStats.new(args['deidentifyStats'], to_s)
          @requested_options = GoogleInSpec::DataLossPrevention::Property::DlpJobRiskDetailsDeidentifyDetailsRequestedOptions.new(args['requestedOptions'], to_s)
        end

        def to_s
          "#{@parent_identifier} DlpJobRiskDetailsDeidentifyDetails"
        end
      end
    end
  end
