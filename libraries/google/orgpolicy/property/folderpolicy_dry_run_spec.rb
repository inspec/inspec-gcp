    ...
    module Property
      class FolderPolicyDryRunSpec
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @rules = GoogleInSpec::Orgpolicy::Property::FolderPolicyDryRunSpecRulesArray.parse(args['rules'], to_s)
          @etag = args['etag']
          @reset = args['reset']
        ...
        def to_s
          "#{@parent_identifier} FolderPolicyDryRunSpec"
        end
      end
    end
  end
