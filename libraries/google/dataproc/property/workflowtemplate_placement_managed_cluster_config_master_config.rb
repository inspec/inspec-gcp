    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigMasterConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @instance_references = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceReferencesArray.parse(args['instanceReferences'], to_s)
          @image_uri = args['imageUri']
          @machine_type_uri = args['machineTypeUri']
          @disk_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigDiskConfig.new(args['diskConfig'], to_s)
          @is_preemptible = args['isPreemptible']
          @preemptibility = args['preemptibility']
          @managed_group_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigManagedGroupConfig.new(args['managedGroupConfig'], to_s)
          @accelerators = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorsArray.parse(args['accelerators'], to_s)
          @min_cpu_platform = args['minCpuPlatform']
          @min_num_instances = args['minNumInstances']
          @instance_flexibility_policy = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceFlexibilityPolicy.new(args['instanceFlexibilityPolicy'], to_s)
          @startup_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigStartupConfig.new(args['startupConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} WorkflowTemplatePlacementManagedClusterConfigMasterConfig"
        end
      end
    end
  end
