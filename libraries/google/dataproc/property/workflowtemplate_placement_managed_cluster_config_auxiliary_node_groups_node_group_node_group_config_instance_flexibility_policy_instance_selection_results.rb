    ...
    module Property
      ...
      class WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionResultsArray
        def self.parse(value, parent_identifier)
          return if value.nil?
          return WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionResults.new(value, parent_identifier) unless value.is_a?(::Array)
          value.map { |v| WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionResults.new(v, parent_identifier) }
        end
      end
    end
  end
