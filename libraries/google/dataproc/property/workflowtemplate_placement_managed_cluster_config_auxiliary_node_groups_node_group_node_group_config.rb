...
module GoogleInSpec
  module Dataproc
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @instance_references = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceReferencesArray.parse(args['instanceReferences'], to_s)
          @image_uri = args['imageUri']
          @machine_type_uri = args['machineTypeUri']
          @disk_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigDiskConfig.new(args['diskConfig'], to_s)
          @is_preemptible = args['isPreemptible']
          @preemptibility = args['preemptibility']
          @managed_group_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigManagedGroupConfig.new(args['managedGroupConfig'], to_s)
          @accelerators = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigAcceleratorsArray.parse(args['accelerators'], to_s)
          @min_cpu_platform = args['minCpuPlatform']
          @min_num_instances = args['minNumInstances']
          @instance_flexibility_policy = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicy.new(args['instanceFlexibilityPolicy'], to_s)
          @startup_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigStartupConfig.new(args['startupConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfig"
        end
      end
    end
  end
