    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigWorkerConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @instance_references = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigInstanceReferencesArray.parse(args['instanceReferences'], to_s)
          @image_uri = args['imageUri']
          @machine_type_uri = args['machineTypeUri']
          @disk_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigDiskConfig.new(args['diskConfig'], to_s)
          @is_preemptible = args['isPreemptible']
          @preemptibility = args['preemptibility']
          @managed_group_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigManagedGroupConfig.new(args['managedGroupConfig'], to_s)
          @accelerators = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigAcceleratorsArray.parse(args['accelerators'], to_s)
          @min_cpu_platform = args['minCpuPlatform']
          @min_num_instances = args['minNumInstances']
          @instance_flexibility_policy = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigInstanceFlexibilityPolicy.new(args['instanceFlexibilityPolicy'], to_s)
          @startup_config = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigStartupConfig.new(args['startupConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} WorkflowTemplatePlacementManagedClusterConfigWorkerConfig"
        end
      end
    end
  end
