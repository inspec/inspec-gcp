...
module GoogleInSpec
  module Dataproc
    module Property
      class ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @tags = args['tags']
          @metadata = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfigMetadata.new(args['metadata'], to_s)
          @reservation_affinity = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfigReservationAffinity.new(args['reservationAffinity'], to_s)
          @node_group_affinity = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfigNodeGroupAffinity.new(args['nodeGroupAffinity'], to_s)
          @shielded_instance_config = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfigShieldedInstanceConfig.new(args['shieldedInstanceConfig'], to_s)
          @confidential_instance_config = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfigConfidentialInstanceConfig.new(args['confidentialInstanceConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGceClusterConfig"
        end
      end
    end
  end
