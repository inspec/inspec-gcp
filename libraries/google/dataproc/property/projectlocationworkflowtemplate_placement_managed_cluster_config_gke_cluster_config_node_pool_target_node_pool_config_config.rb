...
module GoogleInSpec
  module Dataproc
    module Property
      class ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @accelerators = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfigAcceleratorsArray.parse(args['accelerators'], to_s)
        ...
        def to_s
          "#{@parent_identifier} ProjectLocationWorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNodePoolTargetNodePoolConfigConfig"
        end
      end
    end
  end
