    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @namespaced_gke_deployment_target = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNamespacedGkeDeploymentTarget.new(args['namespacedGkeDeploymentTarget'], to_s)
          @gke_cluster_target = args['gkeClusterTarget']
          @node_pool_target = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigGkeClusterConfigNodePoolTargetArray.parse(args['nodePoolTarget'], to_s)
        end
