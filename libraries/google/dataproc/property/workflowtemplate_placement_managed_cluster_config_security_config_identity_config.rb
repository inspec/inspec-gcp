    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigSecurityConfigIdentityConfig
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @user_service_account_mapping = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigSecurityConfigIdentityConfigUserServiceAccountMapping.new(args['userServiceAccountMapping'], to_s)
        end
