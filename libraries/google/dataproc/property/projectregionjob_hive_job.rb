    ...
    module Property
      class ProjectRegionJobHiveJob
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @query_list = GoogleInSpec::Dataproc::Property::ProjectRegionJobHiveJobQueryList.new(args['queryList'], to_s)
          @continue_on_failure = args['continueOnFailure']
          @script_variables = GoogleInSpec::Dataproc::Property::ProjectRegionJobHiveJobScriptVariables.new(args['scriptVariables'], to_s)
          @properties = GoogleInSpec::Dataproc::Property::ProjectRegionJobHiveJobProperties.new(args['properties'], to_s)
          @jar_file_uris = args['jarFileUris']
        end

        def to_s
          "#{@parent_identifier} ProjectRegionJobHiveJob"
        end
      end
    end
  end
