...
module GoogleInSpec
  module Dataproc
    module Property
      class ProjectRegionJobSparkRJob
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @properties = GoogleInSpec::Dataproc::Property::ProjectRegionJobSparkRJobProperties.new(args['properties'], to_s)
          @logging_config = GoogleInSpec::Dataproc::Property::ProjectRegionJobSparkRJobLoggingConfig.new(args['loggingConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectRegionJobSparkRJob"
        end
      end
    end
  end
