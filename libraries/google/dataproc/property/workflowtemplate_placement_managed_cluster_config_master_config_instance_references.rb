    ...
    module Property
      ...
      class WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceReferencesArray
        def self.parse(value, parent_identifier)
          return if value.nil?
          return WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceReferences.new(value, parent_identifier) unless value.is_a?(::Array)
          value.map { |v| WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceReferences.new(v, parent_identifier) }
        end
      end
    end
  end
