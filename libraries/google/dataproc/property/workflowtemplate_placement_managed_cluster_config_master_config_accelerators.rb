...
module GoogleInSpec
  module Dataproc
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerators
      ...
      class WorkflowTemplatePlacementManagedClusterConfigMasterConfigAcceleratorsArray
        def self.parse(value, parent_identifier)
          return if value.nil?
          return WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerators.new(value, parent_identifier) unless value.is_a?(::Array)
          value.map { |v| WorkflowTemplatePlacementManagedClusterConfigMasterConfigAccelerators.new(v, parent_identifier) }
        end
      end
    end
  end
