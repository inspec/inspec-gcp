...
module GoogleInSpec
  module Dataproc
    module Property
      class ProjectRegionJobPrestoJob
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @query_list = GoogleInSpec::Dataproc::Property::ProjectRegionJobPrestoJobQueryList.new(args['queryList'], to_s)
          @continue_on_failure = args['continueOnFailure']
          @output_format = args['outputFormat']
          @client_tags = args['clientTags']
          @properties = GoogleInSpec::Dataproc::Property::ProjectRegionJobPrestoJobProperties.new(args['properties'], to_s)
          @logging_config = GoogleInSpec::Dataproc::Property::ProjectRegionJobPrestoJobLoggingConfig.new(args['loggingConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectRegionJobPrestoJob"
        end
      end
    end
  end
