    ...
    module Property
      class ProjectRegionJobPigJob
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @query_list = GoogleInSpec::Dataproc::Property::ProjectRegionJobPigJobQueryList.new(args['queryList'], to_s)
          @continue_on_failure = args['continueOnFailure']
          @script_variables = GoogleInSpec::Dataproc::Property::ProjectRegionJobPigJobScriptVariables.new(args['scriptVariables'], to_s)
          @properties = GoogleInSpec::Dataproc::Property::ProjectRegionJobPigJobProperties.new(args['properties'], to_s)
          @jar_file_uris = args['jarFileUris']
          @logging_config = GoogleInSpec::Dataproc::Property::ProjectRegionJobPigJobLoggingConfig.new(args['loggingConfig'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectRegionJobPigJob"
        end
      end
    end
  end
