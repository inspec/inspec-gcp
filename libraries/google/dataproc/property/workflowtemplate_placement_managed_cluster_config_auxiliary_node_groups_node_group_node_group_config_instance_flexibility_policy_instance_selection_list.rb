    ...
    module Property
      ...
      class WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionListArray
        def self.parse(value, parent_identifier)
          return if value.nil?
          return WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionList.new(value, parent_identifier) unless value.is_a?(::Array)
          value.map { |v| WorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigInstanceFlexibilityPolicyInstanceSelectionList.new(v, parent_identifier) }
        end
      end
    end
  end
