    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigWorkerConfigInstanceFlexibilityPolicy
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @instance_selection_list = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionListArray.parse(args['instanceSelectionList'], to_s)
          @instance_selection_results = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigWorkerConfigInstanceFlexibilityPolicyInstanceSelectionResultsArray.parse(args['instanceSelectionResults'], to_s)
        end
