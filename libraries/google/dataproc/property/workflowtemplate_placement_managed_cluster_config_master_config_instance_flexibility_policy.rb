    ...
    module Property
      class WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceFlexibilityPolicy
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @instance_selection_list = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionListArray.parse(args['instanceSelectionList'], to_s)
          @instance_selection_results = GoogleInSpec::Dataproc::Property::WorkflowTemplatePlacementManagedClusterConfigMasterConfigInstanceFlexibilityPolicyInstanceSelectionResultsArray.parse(args['instanceSelectionResults'], to_s)
        end
