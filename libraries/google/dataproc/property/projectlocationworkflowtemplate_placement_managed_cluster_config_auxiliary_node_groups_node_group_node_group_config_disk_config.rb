...
module GoogleInSpec
  module Dataproc
    module Property
      class ProjectLocationWorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigDiskConfig
        ...
        def to_s
          "#{@parent_identifier} ProjectLocationWorkflowTemplatePlacementManagedClusterConfigAuxiliaryNodeGroupsNodeGroupNodeGroupConfigDiskConfig"
        end
      end
    end
  end
