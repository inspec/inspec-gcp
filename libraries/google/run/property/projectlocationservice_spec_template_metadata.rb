...
module GoogleInSpec
  module Run
    module Property
      class ProjectLocationServiceSpecTemplateMetadata
        attr_reader :name
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @labels = GoogleInSpec::Run::Property::ProjectLocationServiceSpecTemplateMetadataLabels.new(args['labels'], to_s)
          @annotations = GoogleInSpec::Run::Property::ProjectLocationServiceSpecTemplateMetadataAnnotations.new(args['annotations'], to_s)
          @owner_references = GoogleInSpec::Run::Property::ProjectLocationServiceSpecTemplateMetadataOwnerReferencesArray.parse(args['ownerReferences'], to_s)
        ...
        def to_s
          "#{@parent_identifier} ProjectLocationServiceSpecTemplateMetadata"
        end
      end
    end
  end
