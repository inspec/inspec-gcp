...
module GoogleInSpec
  module Run
    module Property
      class ServiceSpecTemplateMetadata
        attr_reader :name
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @labels = GoogleInSpec::Run::Property::ServiceSpecTemplateMetadataLabels.new(args['labels'], to_s)
          @annotations = GoogleInSpec::Run::Property::ServiceSpecTemplateMetadataAnnotations.new(args['annotations'], to_s)
          @owner_references = GoogleInSpec::Run::Property::ServiceSpecTemplateMetadataOwnerReferencesArray.parse(args['ownerReferences'], to_s)
        ...
        def to_s
          "#{@parent_identifier} ServiceSpecTemplateMetadata"
        end
      end
    end
  end
