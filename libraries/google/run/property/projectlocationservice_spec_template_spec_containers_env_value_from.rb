...
module GoogleInSpec
  module Run
    module Property
      class ProjectLocationServiceSpecTemplateSpecContainersEnvValueFrom
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @config_map_key_ref = GoogleInSpec::Run::Property::ProjectLocationServiceSpecTemplateSpecContainersEnvValueFromConfigMapKeyRef.new(args['configMapKeyRef'], to_s)
          @secret_key_ref = GoogleInSpec::Run::Property::ProjectLocationServiceSpecTemplateSpecContainersEnvValueFromSecretKeyRef.new(args['secretKeyRef'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectLocationServiceSpecTemplateSpecContainersEnvValueFrom"
        end
      end
    end
  end
