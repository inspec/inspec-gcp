...
module GoogleInSpec
  module Run
    module Property
      class ServiceSpecTemplateSpecContainersStartupProbe
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @exec = GoogleInSpec::Run::Property::ServiceSpecTemplateSpecContainersStartupProbeExec.new(args['exec'], to_s)
          @http_get = GoogleInSpec::Run::Property::ServiceSpecTemplateSpecContainersStartupProbeHttpGet.new(args['httpGet'], to_s)
          @tcp_socket = GoogleInSpec::Run::Property::ServiceSpecTemplateSpecContainersStartupProbeTcpSocket.new(args['tcpSocket'], to_s)
          @grpc = GoogleInSpec::Run::Property::ServiceSpecTemplateSpecContainersStartupProbeGrpc.new(args['grpc'], to_s)
        end

        def to_s
          "#{@parent_identifier} ServiceSpecTemplateSpecContainersStartupProbe"
        end
      end
    end
  end
