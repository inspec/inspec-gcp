  ...
  module Compute
    module Property
      class RegionBackendServiceCdnPolicy
        attr_reader :cache_key_policy, :signed_url_cache_max_age_sec, :default_ttl, :max_ttl, :client_ttl, :negative_caching, :negative_caching_policy, :cache_mode, :serve_while_stale
