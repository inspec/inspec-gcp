...
module GoogleInSpec
  module DataprocMetastore
    module Property
      class ProjectLocationServiceBackupServiceRevisionScheduledBackup
        attr_reader :enabled
        ...
        def initialize(args = nil, parent_identifier = nil)
          ...
          @latest_backup = GoogleInSpec::DataprocMetastore::Property::ProjectLocationServiceBackupServiceRevisionScheduledBackupLatestBackup.new(args['latestBackup'], to_s)
        end

        def to_s
          "#{@parent_identifier} ProjectLocationServiceBackupServiceRevisionScheduledBackup"
        end
      end
    end
  end
