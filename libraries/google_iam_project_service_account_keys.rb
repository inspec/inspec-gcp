...
# ----------------------------------------------------------------------------
require 'gcp_backend'
class IAMProjectServiceAccountKeys < GcpResourceBase
  name 'google_iam_project_service_account_keys'
  desc 'ProjectServiceAccountKey plural resource'
  ...
  def initialize(params = {})
    ...
    @params = params
    @table = fetch_wrapped_resource('projectServiceAccountKeys')
  end
  ...
  def transformers
    {
      ...
      'validAfterTime' => ->(obj) { [:valid_after_time, obj['validAfterTime']] },
      'validBeforeTime' => ->(obj) { [:valid_before_time, obj['validBeforeTime']] },
