...
# ----------------------------------------------------------------------------
require 'gcp_backend'
class DataLossPreventionJobTriggers < GcpResourceBase
  name 'google_data_loss_prevention_job_triggers'
  ...
  def transformers
    {
      ...
      'triggers' => ->(obj) { return :triggers, GoogleInSpec::DataLossPrevention::Property::JobTriggerTriggersArray.parse(obj['triggers'], to_s) },
      'inspectJob' => ->(obj) { return :inspect_job, GoogleInSpec::DataLossPrevention::Property::JobTriggerInspectJob.new(obj['inspectJob'], to_s) },
