...
# ----------------------------------------------------------------------------
require 'gcp_backend'
require 'google/dataproc/property/projectlocationworkflowtemplate_encryption_config'
require 'google/dataproc/property/projectlocationworkflowtemplate_jobs'
require 'google/dataproc/property/projectlocationworkflowtemplate_labels'
require 'google/dataproc/property/projectlocationworkflowtemplate_parameters'
require 'google/dataproc/property/projectlocationworkflowtemplate_placement'
require 'google/dataproc/property/projectlocationworkflowtemplate_placement_cluster_selector'
require 'google/dataproc/property/projectlocationworkflowtemplate_placement_cluster_selector_cluster_labels'
require 'google/dataproc/property/projectlocationworkflowtemplate_placement_managed_cluster'
...
class DataprocProjectLocationWorkflowTemplate < GcpResourceBase
  name 'google_dataproc_project_location_workflow_template'
  desc 'ProjectLocationWorkflowTemplate'
  ...
  def parse
    ...
    @labels = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplateLabels.new(@fetched['labels'], to_s)
    @placement = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplatePlacement.new(@fetched['placement'], to_s)
    @jobs = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplateJobsArray.parse(@fetched['jobs'], to_s)
    @parameters = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplateParametersArray.parse(@fetched['parameters'], to_s)
    @dag_timeout = @fetched['dagTimeout']
    @encryption_config = GoogleInSpec::Dataproc::Property::ProjectLocationWorkflowTemplateEncryptionConfig.new(@fetched['encryptionConfig'], to_s)
  end
  ...
  def to_s
    "ProjectLocationWorkflowTemplate #{@params[:]}"
  end
