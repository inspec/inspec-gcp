...
# ----------------------------------------------------------------------------
require 'gcp_backend'
class DataLossPreventionInspectTemplates < GcpResourceBase
  name 'google_data_loss_prevention_inspect_templates'
  ...
  def transformers
    {
      ...
      'inspectConfig' => ->(obj) { return :inspect_config, GoogleInSpec::DataLossPrevention::Property::InspectTemplateInspectConfig.new(obj['inspectConfig'], to_s) },
