...
class ComputeSnapshot < GcpResourceBase
  ...
  attr_reader :params, :creation_timestamp, :id, :disk_size_gb, :name, :description, :storage_bytes, :storage_locations, :licenses, :labels, :label_fingerprint, :source_disk, :zone, :snapshot_encryption_key, :source_disk_encryption_key
