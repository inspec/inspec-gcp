...
class ComputeServiceAttachment < GcpResourceBase
  ...
  def parse
    ...
    @connected_endpoints = @fetched['connectedEndpoints']
    ...
    @consumer_accept_lists = @fetched['consumerAcceptLists']
    @psc_service_attachment_id = @fetched['pscServiceAttachmentId']
