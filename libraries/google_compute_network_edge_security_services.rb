...
# ----------------------------------------------------------------------------
require 'gcp_backend'
class ComputeNetworkEdgeSecurityServices < GcpResourceBase
  name 'google_compute_network_edge_security_services'
  desc 'NetworkEdgeSecurityService plural resource'
  ...
  def initialize(params = {})
    ...
    @params = params
    @table = fetch_wrapped_resource('networkEdgeSecurityServices')
  end
