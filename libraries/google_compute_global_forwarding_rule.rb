...
class ComputeGlobalForwardingRule < GcpResourceBase
  ...
  attr_reader :params, :creation_timestamp, :description, :id, :ip_address, :ip_protocol, :ip_version, :labels, :label_fingerprint, :load_balancing_scheme, :metadata_filters, :name, :network, :port_range, :target
