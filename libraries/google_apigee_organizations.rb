...
class ApigeeOrganizations < GcpResourceBase
  ...
  def transformers
    {
      'apiConsumerDataEncryptionKeyName' => ->(obj) { return :api_consumer_data_encryption_key_name, obj['apiConsumerDataEncryptionKeyName'] },
      'runtimeDatabaseEncryptionKeyName' => ->(obj) { return :runtime_database_encryption_key_name, obj['runtimeDatabaseEncryptionKeyName'] },
      'environments' => ->(obj) { return :environments, obj['environments'] },
      'runtimeType' => ->(obj) { return :runtime_type, obj['runtimeType'] },
      'type' => ->(obj) { return :type, obj['type'] },
      'portalDisabled' => ->(obj) { return :portal_disabled, obj['portalDisabled'] },
      ...
      'caCertificate' => ->(obj) { return :ca_certificate, obj['caCertificate'] },
      'subscriptionType' => ->(obj) { return :subscription_type, obj['subscriptionType'] },
      'addonsConfig' => ->(obj) { return :addons_config, GoogleInSpec::Apigee::Property::OrganizationAddonsConfig.new(obj['addonsConfig'], to_s) },
      ...
      'subscriptionPlan' => ->(obj) { return :subscription_plan, obj['subscriptionPlan'] },
      'properties' => ->(obj) { return :properties, GoogleInSpec::Apigee::Property::OrganizationProperties.new(obj['properties'], to_s) },
      'state' => ->(obj) { return :state, obj['state'] },
      'name' => ->(obj) { return :name, obj['name'] },
      'disableVpcPeering' => ->(obj) { return :disable_vpc_peering, obj['disableVpcPeering'] },
      'controlPlaneEncryptionKeyName' => ->(obj) { return :control_plane_encryption_key_name, obj['controlPlaneEncryptionKeyName'] },
      'analyticsRegion' => ->(obj) { return :analytics_region, obj['analyticsRegion'] },
      'apiConsumerDataLocation' => ->(obj) { return :api_consumer_data_location, obj['apiConsumerDataLocation'] },
      'displayName' => ->(obj) { return :display_name, obj['displayName'] },
      'apigeeProjectId' => ->(obj) { return :apigee_project_id, obj['apigeeProjectId'] },
      'expiresAt' => ->(obj) { return :expires_at, obj['expiresAt'] },
      'attributes' => ->(obj) { return :attributes, obj['attributes'] },
      'billingType' => ->(obj) { return :billing_type, obj['billingType'] },
    }
  end
