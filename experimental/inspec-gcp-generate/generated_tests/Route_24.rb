...
control 'Route_24' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-f380239a67a9fd8c"}) do
    it { should exist }

    its('dest_range') { should cmp "10.162.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.162.0.0/20." }
    its('name') { should cmp "default-route-f380239a67a9fd8c" }
