...
control 'Route_21' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-d0b0e51c9da7f346"}) do
    it { should exist }

    its('dest_range') { should cmp "10.142.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.142.0.0/20." }
    its('name') { should cmp "default-route-d0b0e51c9da7f346" }
