...
control 'Route_20' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-ccfc42e3160726f2"}) do
    it { should exist }

    its('dest_range') { should cmp "10.164.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.164.0.0/20." }
    its('name') { should cmp "default-route-ccfc42e3160726f2" }
