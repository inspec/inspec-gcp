...
control 'Route_0' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-01667ebc509828ff"}) do
    it { should exist }

    its('dest_range') { should cmp "10.170.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.170.0.0/20." }
    its('name') { should cmp "default-route-01667ebc509828ff" }
