...
control 'Route_8' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-6f17e51716e3300e"}) do
    it { should exist }

    its('dest_range') { should cmp "10.152.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.152.0.0/20." }
    its('name') { should cmp "default-route-6f17e51716e3300e" }
