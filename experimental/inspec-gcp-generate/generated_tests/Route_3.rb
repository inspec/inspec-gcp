...
control 'Route_3' do
  ...
  describe google_compute_route({:project=>"graphite-test-sam-chef", :name=>"default-route-36b4bf158cec7caf"}) do
    it { should exist }

    its('dest_range') { should cmp "10.172.0.0/20" }
    its('description') { should cmp "Default local route to the subnetwork 10.172.0.0/20." }
    its('name') { should cmp "default-route-36b4bf158cec7caf" }
